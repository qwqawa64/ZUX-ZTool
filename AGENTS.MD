...
1. Create a Hook class that extends `BaseHookModule`. Prefer **Kotlin** (`.kt`) for new hooks; Java is acceptable only when it fundamentally conflicts with existing infrastructure.
