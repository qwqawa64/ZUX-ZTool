...
object PreferenceKeys {
    ...
    val VOLUME_DETAIL_PANEL = BoolKey("volume_detail_panel", false)
    ...
    val LOCK_SCREEN_CLOCK_COLOR_CUSTOM = BoolKey("lock_screen_clock_color_custom", false)
    val FORCE_LONG_SCREENSHOT = BoolKey("force_long_screenshot", false)
    val FORCE_LONG_SCREENSHOT_AOSP = BoolKey("force_long_screenshot_aosp", false)
    ...
    val booleanKeys: List<BoolKey> = listOf(
        ...
        CONTROL_CENTER_LONG_PRESS, VOLUME_DETAIL_PANEL, HIDE_DETAIL_INDICATOR, QS_COLOR,
        ...
        DISABLE_BIOMETRIC_ERROR_VIBRATION, BYPASS_FACE_AUTH_TIMEOUT,
        FORCE_LONG_SCREENSHOT, FORCE_LONG_SCREENSHOT_AOSP,
