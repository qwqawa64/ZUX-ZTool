...
package com.qimian233.ztool.screens.systemui.controlcenter
...
fun ControlCenterSettingsRoute(
    ...
    HighlightController(
        ...
        ControlCenterSettingsScreen(
            ...
            onVolumeLongPressPanelChanged = viewModel::setVolumeLongPressPanelEnabled,
...
private fun ControlCenterSettingsScreen(
    ...
    onVolumeLongPressPanelChanged: (Boolean) -> Unit,
            ...
            Column(
                ...
                ZToolSettingsList(
                    sections = controlCenterSettingsSections(
                        ...
                        onVolumeLongPressPanelChanged = onVolumeLongPressPanelChanged,
    ...
    return listOf(
        ...
        SettingSection(
            ...
            items = buildList {
                ...
                add(
                    SettingItem.Switch(
                        title = stringResource(R.string.system_ui_volume_long_press_panel_title),
                        summary = stringResource(R.string.system_ui_volume_long_press_panel_summary),
                        checked = state.volumeLongPressPanelEnabled,
                        onCheckedChange = onVolumeLongPressPanelChanged,
                        key = "volume_long_press_panel"
                    )
                )
                add(
                    SettingItem.Switch(
        ...
        SettingSection(
            ...
            items = buildList {
                ...
                if (state.textSizeEnabled) {
                    add(
                        SettingItem.Custom(
                            key = "dyn_control_center_clock_text_size_slider",
                            content = {
                                ClockFormatSlider(
                ...
                if (state.letterSpacingEnabled) {
                    add(
                        SettingItem.Custom(
                            key = "dyn_control_center_clock_letter_spacing_slider",
                            content = {
                                ClockFormatSlider(
